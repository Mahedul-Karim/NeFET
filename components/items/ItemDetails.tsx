...
const ItemDetails: React.FC<Props> = ({ id }) => {
  const { items } = useCtx();
      ...
      <div className="grid gap-10 lg:grid-cols-2">
        ...
        <div>
          <div className="flex items-center gap-2 flex-wrap">
            <Badge
              variant="outline"
              className="border border-border-subtle text-secondary-text"
            >
              {item?.category}
            </Badge>
          ...
          <div className="mt-8 rounded-2xl border border-border-subtle bg-card p-6">
            ...
            <div className="mt-5 flex flex-col sm:flex-row gap-3">
              ...
              <Button
                size="lg"
                variant="outline"
                className=" border-border-subtle text-primary-text bg-transparent hover:bg-transparent hover:text-primary-text sm:grow"
              >
                Place Bid
              </Button>
            </div>
          ...
          <div className="mt-8">
            ...
            <dl className="mt-4 grid grid-cols-2 gap-4 text-sm">
              <div className="rounded-lg border border-border-subtle p-4">
                ...
                <dd className="mt-1 font-medium text-secondary-text">
                  {item?.category}
                </dd>
              </div>
              <div className="rounded-lg border border-border-subtle p-4">
              ...
              <div className="rounded-lg border border-border-subtle p-4">
                ...
                <dd className="mt-1 font-medium truncate text-secondary-text">
                  {item?.creator}
                </dd>
              </div>
            </dl>
